...
VER="1.0.0"
#ARM64 交叉编译器
FILENAME_EDGE_GCC_LINARO="gcc-linaro-6.2.1-2016.11-x86_64_aarch64-linux-gnu.tgz"
#M0 交叉编译器
FILENAME_EDGE_GCC_ARM="gcc-arm-none-eabi-8-2018-q4-major.tar.gz"

#################### docker ####################
#Work
PATH_WORK="edge-cross-compile"
